/*
 ...
 Source Schema         : minshuku

 Target Server Type    : MySQL
 Target Server Version : 80017
 File Encoding         : 65001

 Date: 26/06/2020 17:08:47
*/
...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES (1, 'admin', 'admin', '2020-05-02 14:21:47', '2020-05-02 14:21:47');
...
CREATE TABLE `carousel`  (
  ...
  `home_id` int(20) NULL DEFAULT NULL COMMENT '房屋ID',
  `link` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '链接地址',
  `imgUrl` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '图片URL',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of carousel
-- ----------------------------
INSERT INTO `carousel` VALUES (5, 6, 'http://localhost:8080/detail/6', 'http://localhost:8000/minshuku/img/fcb1db3d79b34f86bc0d1846df7d2697.jpg@1920w_1080h');
INSERT INTO `carousel` VALUES (6, 5, 'http://localhost:8080/detail/5', 'http://localhost:8000/minshuku/img/7aee9616c0b24490aa473deff835b6cf.jpg@1920w_1080h');
INSERT INTO `carousel` VALUES (7, 7, 'http://localhost:8080/detail/7', 'http://localhost:8000/minshuku/img/4bfdc87cdae94992836aa070fa996341.jpg@1920w_1080h');
INSERT INTO `carousel` VALUES (8, 8, 'http://localhost:8080/detail/8', 'http://localhost:8000/minshuku/img/f4692eb9db6b4cc7ba453d2cb7c1d769.jpg@1920w_1080h');
INSERT INTO `carousel` VALUES (9, 10, 'http://localhost:8080/detail/10', 'http://localhost:8000/minshuku/img/04a112a8982d47c495e4e5bb5f06a1d0.jpg@1920w_1080h');
INSERT INTO `carousel` VALUES (10, 1, 'http://localhost:8080/detail/1', 'http://localhost:8000/minshuku/img/db7030bde09749859b768540b4dbd303.jpg@1920w_1080h');
...
CREATE TABLE `collect`  (
  `id` int(20) NOT NULL AUTO_INCREMENT,
  `home_id` int(20) NOT NULL COMMENT '房屋ID',
...
-- Records of collect
-- ----------------------------
INSERT INTO `collect` VALUES (3, 3, 1, '2020-05-15 08:46:20', '2020-05-15 08:46:20');
INSERT INTO `collect` VALUES (5, 4, 1, '2020-05-15 08:46:27', '2020-05-15 08:46:27');
INSERT INTO `collect` VALUES (7, 5, 1, '2020-05-15 08:56:38', '2020-05-15 08:56:38');
INSERT INTO `collect` VALUES (9, 6, 2, '2020-06-02 09:19:37', '2020-06-02 09:19:37');
INSERT INTO `collect` VALUES (10, 1, 1, '2020-06-10 10:04:26', '2020-06-10 10:04:26');
...
CREATE TABLE `home`  (
  `id` int(20) NOT NULL AUTO_INCREMENT COMMENT '房屋ID',
  `host_id` int(20) NOT NULL COMMENT '房东ID',
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '标题',
  `describe` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '房屋描述',
  `price` decimal(10, 2) NOT NULL COMMENT '价格',
  `address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '地址',
  `area` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '面积（㎡）',
  `livepeople` int(2) NOT NULL COMMENT '可以居住几人',
  `collection` int(20) NOT NULL DEFAULT 0 COMMENT '收藏数量',
  `status` int(1) UNSIGNED ZEROFILL NOT NULL COMMENT '0（未审核）\r\n1（审核通过）',
  `flag` int(1) NOT NULL DEFAULT 0 COMMENT '是否加入轮播 0：否，1：是',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of home
-- ----------------------------
INSERT INTO `home` VALUES (1, 2, '网红北欧ins风一居', '离地铁近。', 179.00, '北京市辖区东城区安定门', '50', 2, 1, 1, 1, '2020-05-15 07:42:42', '2020-06-10 10:04:26');
INSERT INTO `home` VALUES (2, 2, '绿藤美居', '独立的楼宇', 180.00, '北京市辖区东城区', '40', 1, 0, 1, 0, '2020-05-15 08:24:17', '2020-06-10 10:04:36');
INSERT INTO `home` VALUES (3, 2, '古德耐', '交通方便', 150.00, '北京市辖区东城区', '40', 2, 1, 1, 0, '2020-05-15 08:29:22', '2020-05-23 13:48:26');
INSERT INTO `home` VALUES (4, 2, '良乡大学城', '方便上学', 200.00, '北京市辖区东城区', '50', 2, 1, 1, 0, '2020-05-15 08:33:30', '2020-05-23 13:48:32');
INSERT INTO `home` VALUES (5, 2, 'ins风轻奢loft', '地理位置较好，地铁附近', 250.00, '北京市辖区东城区', '50', 2, 1, 1, 1, '2020-05-15 08:37:07', '2020-05-23 13:48:37');
INSERT INTO `home` VALUES (6, 2, '甜甜小窝', '清新ins风', 500.00, '北京市辖区昌平区', '85', 2, 5, 0, 1, '2020-05-15 08:44:32', '2020-06-09 18:33:38');
INSERT INTO `home` VALUES (7, 1, '简约风', '离地铁近', 250.00, '北京市辖区海淀区', '70', 2, 0, 0, 1, '2020-05-15 09:31:01', '2020-06-02 10:37:58');
INSERT INTO `home` VALUES (8, 1, '懒悠悠', '一抹青石勾起月上西山，一处闲暇演绎漫漫故事……', 108.00, '北京市辖区东城区', '52', 2, 0, 1, 1, '2020-05-20 18:10:04', '2020-05-23 13:49:23');
INSERT INTO `home` VALUES (9, 1, '朝夕', '此房源位于城市中心商圈，', 152.00, '北京市辖区东城区', '50', 2, 0, 1, 0, '2020-05-20 18:21:52', '2020-05-21 20:47:16');
INSERT INTO `home` VALUES (10, 1, 'tomato', '房子均为实拍，位于宽窄巷子附近的一处商业广场，精装公寓', 200.00, '北京市辖区东城区', '60', 6, 0, 1, 1, '2020-05-20 20:06:25', '2020-05-23 13:49:29');
INSERT INTO `home` VALUES (11, 1, '1111', '1', 1.00, '北京市辖区东城区', '1', 1, 0, 1, 0, '2020-06-02 10:48:17', '2020-06-10 10:06:59');
INSERT INTO `home` VALUES (12, 1, '333', '3333', 333.00, '北京市辖区东城区', '33', 3, 0, 1, 0, '2020-06-10 10:11:47', '2020-06-10 10:12:10');
...
CREATE TABLE `home_detail`  (
  ...
  `suite` int(1) NOT NULL COMMENT '是否是整套房：0否，1是',
  `bedroom` int(2) NOT NULL COMMENT '卧室数量',
  `livingroom` int(2) NOT NULL COMMENT '厅',
  `kitchen` int(1) NOT NULL COMMENT '是否有厨房：0没有，1有',
  `toilet` int(1) NOT NULL COMMENT '是否有厕所：0没有，1有',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `home_detail` VALUES (1, 1, 1, 2, 1, 1, 1);
INSERT INTO `home_detail` VALUES (2, 2, 0, 1, 1, 1, 1);
INSERT INTO `home_detail` VALUES (3, 3, 0, 1, 1, 1, 1);
INSERT INTO `home_detail` VALUES (4, 4, 0, 1, 2, 1, 1);
INSERT INTO `home_detail` VALUES (5, 5, 0, 1, 1, 1, 1);
INSERT INTO `home_detail` VALUES (6, 6, 1, 1, 1, 1, 1);
INSERT INTO `home_detail` VALUES (7, 7, 1, 2, 1, 1, 1);
INSERT INTO `home_detail` VALUES (8, 8, 1, 1, 1, 1, 1);
INSERT INTO `home_detail` VALUES (9, 9, 1, 1, 1, 1, 1);
INSERT INTO `home_detail` VALUES (10, 10, 1, 3, 2, 1, 1);
INSERT INTO `home_detail` VALUES (11, 11, 1, 1, 1, 1, 1);
INSERT INTO `home_detail` VALUES (12, 12, 1, 2, 2, 1, 1);
...
-- Records of img
-- ----------------------------
INSERT INTO `img` VALUES (1, 1, 'http://localhost:8000/minshuku/img/db7030bde09749859b768540b4dbd303.jpg@1920w_1080h');
INSERT INTO `img` VALUES (2, 1, 'http://localhost:8000/minshuku/img/1adcd716e45d49d2a9cb44cf60e4e14a.jpg@1920w_1080h');
INSERT INTO `img` VALUES (3, 1, 'http://localhost:8000/minshuku/img/327191a55d874ddab7e490774abcfaa0.jpg@200w_140h_10Q_1e_1c');
INSERT INTO `img` VALUES (4, 1, 'http://localhost:8000/minshuku/img/f7a86867dab3489ca9de8deccb2dcb5c.jpg@1920w_1080h');
INSERT INTO `img` VALUES (5, 1, 'http://localhost:8000/minshuku/img/e4e9e07d5cc448e0a363f4b159536ca0.jpg@1920w_1080h');
INSERT INTO `img` VALUES (6, 2, 'http://localhost:8000/minshuku/img/f3c219e001d846928f7bbb61582a4df4.png@1920w_1080h');
INSERT INTO `img` VALUES (7, 2, 'http://localhost:8000/minshuku/img/5a75b9d031ed4a6fb6760381aded7023.png@1920w_1080h');
INSERT INTO `img` VALUES (8, 2, 'http://localhost:8000/minshuku/img/7bf9bb1ac610419087647959a551ebb9.png@1920w_1080h');
INSERT INTO `img` VALUES (9, 2, 'http://localhost:8000/minshuku/img/bad5c797227f4d628511b5c316683104.png@1920w_1080h');
INSERT INTO `img` VALUES (10, 2, 'http://localhost:8000/minshuku/img/f756d97a07504d939910d76a2ca5ca93.png@1920w_1080h');
INSERT INTO `img` VALUES (11, 3, 'http://localhost:8000/minshuku/img/a9fb640681904ba9b944cd37362b10a1.png@1920w_1080h');
INSERT INTO `img` VALUES (12, 3, 'http://localhost:8000/minshuku/img/af3b814434804a578f3f9ec6c60c480a.jpg@1920w_1080h');
INSERT INTO `img` VALUES (13, 3, 'http://localhost:8000/minshuku/img/57a4e09ba9e14ec780b2ffd351e6daef.png@1920w_1080h');
INSERT INTO `img` VALUES (14, 3, 'http://localhost:8000/minshuku/img/b31edeba87cf4391add8ecec37a88139.jpg@1920w_1080h');
INSERT INTO `img` VALUES (15, 3, 'http://localhost:8000/minshuku/img/629590f75aca4e839adea07503cfbb16.jpg@1920w_1080h');
INSERT INTO `img` VALUES (16, 4, 'http://localhost:8000/minshuku/img/ad778a223bfc4657a26dbca0b3559614.jpg@1920w_1080h');
INSERT INTO `img` VALUES (17, 4, 'http://localhost:8000/minshuku/img/3a07c7b51e4a4da6b5780927ef78a42b.jpg@1920w_1080h');
INSERT INTO `img` VALUES (18, 4, 'http://localhost:8000/minshuku/img/5254cfdd72d149ce9c58d27249a2fb74.jpg@1920w_1080h');
INSERT INTO `img` VALUES (19, 4, 'http://localhost:8000/minshuku/img/e17ae29abfb34132af230026e91d4395.jpg@1920w_1080h');
INSERT INTO `img` VALUES (20, 4, 'http://localhost:8000/minshuku/img/d8af6e000428406fa10a07f6edf66250.jpg@1920w_1080h');
INSERT INTO `img` VALUES (21, 5, 'http://localhost:8000/minshuku/img/7aee9616c0b24490aa473deff835b6cf.jpg@1920w_1080h');
INSERT INTO `img` VALUES (22, 5, 'http://localhost:8000/minshuku/img/31c64d768bf44e0fa12b22779cd24459.jpg@1920w_1080h');
INSERT INTO `img` VALUES (23, 5, 'http://localhost:8000/minshuku/img/e3c7d036233741849b51b4c38970519e.jpg@1920w_1080h');
INSERT INTO `img` VALUES (24, 5, 'http://localhost:8000/minshuku/img/dbc87c704753433284582a828d5071d1.jpg@1920w_1080h');
INSERT INTO `img` VALUES (25, 5, 'http://localhost:8000/minshuku/img/a879315957404cc89601101f13a06fc0.jpg@1920w_1080h');
INSERT INTO `img` VALUES (26, 6, 'http://localhost:8000/minshuku/img/fcb1db3d79b34f86bc0d1846df7d2697.jpg@1920w_1080h');
INSERT INTO `img` VALUES (27, 6, 'http://localhost:8000/minshuku/img/86d0127d73174f299c6c4b191e564ff5.jpg@1920w_1080h');
INSERT INTO `img` VALUES (28, 6, 'http://localhost:8000/minshuku/img/d109f845d35f458ab9a12e525f1cbf30.jpg@1920w_1080h');
INSERT INTO `img` VALUES (29, 6, 'http://localhost:8000/minshuku/img/348440859877476d8a87e70da3016f50.jpg@1920w_1080h');
INSERT INTO `img` VALUES (30, 6, 'http://localhost:8000/minshuku/img/a74c610ab3d34215a0a716da346164ca.jpg@1920w_1080h');
INSERT INTO `img` VALUES (31, 7, 'http://localhost:8000/minshuku/img/4bfdc87cdae94992836aa070fa996341.jpg@1920w_1080h');
INSERT INTO `img` VALUES (32, 7, 'http://localhost:8000/minshuku/img/4675bfc166fa45faadc5bda327e45823.jpg@1920w_1080h');
INSERT INTO `img` VALUES (33, 7, 'http://localhost:8000/minshuku/img/ae2bda2213e0441cb0f67729f61012fe.jpg@1920w_1080h');
INSERT INTO `img` VALUES (34, 7, 'http://localhost:8000/minshuku/img/03522c4ce3e041ae98b68000388a8cf8.jpg@1920w_1080h');
INSERT INTO `img` VALUES (35, 7, 'http://localhost:8000/minshuku/img/067c26ed4b8e4f3a993bb706df2a77d3.jpg@1920w_1080h');
INSERT INTO `img` VALUES (36, 8, 'http://localhost:8000/minshuku/img/f4692eb9db6b4cc7ba453d2cb7c1d769.jpg@1920w_1080h');
INSERT INTO `img` VALUES (37, 8, 'http://localhost:8000/minshuku/img/1380ae44116e4d54a5c529eeaf3c2379.jpg@1920w_1080h');
INSERT INTO `img` VALUES (38, 8, 'http://localhost:8000/minshuku/img/47d5d4a3b46b481bb3938d8bead63a16.jpg@200w_140h_10Q_1e_1c');
INSERT INTO `img` VALUES (39, 8, 'http://localhost:8000/minshuku/img/c46c8cd607404935a5d80973f01cee38.jpg@200w_140h_10Q_1e_1c');
INSERT INTO `img` VALUES (40, 8, 'http://localhost:8000/minshuku/img/2cab9e22748e44f4a6ccdc24fcce051f.jpg@1920w_1080h');
INSERT INTO `img` VALUES (41, 9, 'http://localhost:8000/minshuku/img/f12ce107efc340a293668f2e15178274.jpg@1920w_1080h');
INSERT INTO `img` VALUES (42, 9, 'http://localhost:8000/minshuku/img/b6adedcc1afc44478ffeebb5505595b1.jpg@1920w_1080h');
INSERT INTO `img` VALUES (43, 9, 'http://localhost:8000/minshuku/img/bdf9b818ea234bd48d5b8db9b6f32669.jpg@1920w_1080h');
INSERT INTO `img` VALUES (44, 9, 'http://localhost:8000/minshuku/img/2590dde2692d4a59bfb98dbcfbe36475.jpg@1920w_1080h');
INSERT INTO `img` VALUES (45, 9, 'http://localhost:8000/minshuku/img/a110c2f5a63e4ed28e12d35ec9357d6d.jpg@200w_140h_10Q_1e_1c');
INSERT INTO `img` VALUES (46, 10, 'http://localhost:8000/minshuku/img/04a112a8982d47c495e4e5bb5f06a1d0.jpg@1920w_1080h');
INSERT INTO `img` VALUES (47, 10, 'http://localhost:8000/minshuku/img/14d9a292953c478cb579e9321e1d19c5.jpg@1920w_1080h');
INSERT INTO `img` VALUES (48, 10, 'http://localhost:8000/minshuku/img/067059f081114073b7aaa6f8f91df992.jpg@1920w_1080h');
INSERT INTO `img` VALUES (49, 10, 'http://localhost:8000/minshuku/img/5e3630799c2042adb38fff3170b8b885.jpg@1920w_1080h');
INSERT INTO `img` VALUES (50, 10, 'http://localhost:8000/minshuku/img/a38bef1fa6d24306a8c1854269ae4a30.jpg@1920w_1080h');
INSERT INTO `img` VALUES (51, 11, 'http://localhost:8000/minshuku/img/cb5f24f2cee44393b9faba5555ac6c11.jpg@1920w_1080h');
INSERT INTO `img` VALUES (52, 11, 'http://localhost:8000/minshuku/img/d259e7f8ea13412f89f8554422320d28.jpg@1920w_1080h');
INSERT INTO `img` VALUES (53, 11, 'http://localhost:8000/minshuku/img/f2407e6a849f451aaf15a3e85680deed.jpg@1920w_1080h');
INSERT INTO `img` VALUES (54, 11, 'http://localhost:8000/minshuku/img/b64a33bf201a43b4846f8bfa0360b365.jpg@1920w_1080h');
INSERT INTO `img` VALUES (55, 11, 'http://localhost:8000/minshuku/img/8bcf918b632c44e9bea084be917632cf.jpg@1920w_1080h');
INSERT INTO `img` VALUES (56, 12, 'http://localhost:8000/minshuku/img/12a1027a855a41158ff490a1f5dc6aa9.jpg');
INSERT INTO `img` VALUES (57, 12, 'http://localhost:8000/minshuku/img/f5f7939a0dfa4b7cac6f74100a258739.jpg');
INSERT INTO `img` VALUES (58, 12, 'http://localhost:8000/minshuku/img/51a11cbbacb14318b35495c4c61e0557.jpg');
INSERT INTO `img` VALUES (59, 12, 'http://localhost:8000/minshuku/img/f49ab46daff94ef59455e8b668baee1c.jpg');
INSERT INTO `img` VALUES (60, 12, 'http://localhost:8000/minshuku/img/15b49d579f524085b98e1aa95f60364e.jpg');
...
CREATE TABLE `order_info`  (
  ...
  `user_id` int(20) NOT NULL COMMENT '用户ID',
  `home_id` int(20) NOT NULL COMMENT '房屋ID',
  `address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '房屋地址',
  `start_time` date NOT NULL COMMENT '入住时间',
  `end_time` date NOT NULL COMMENT '离开时间',
  `live_num` int(2) NOT NULL COMMENT '入住人数',
  `price` decimal(10, 2) NOT NULL COMMENT '价格',
  `live_days` int(20) NOT NULL COMMENT '单位：天',
  `count_price` decimal(10, 2) NOT NULL COMMENT '总共支付',
  `phone_num` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '联系方式',
  `live_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '租客姓名',
  `type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '证件类型',
  `id_num` varchar(18) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '证件号码',
  `status` int(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '状态：0 未入住；1 进行中；2已完成',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `order_info` VALUES (1, 1, 6, '北京市辖区昌平区', '2020-04-15', '2020-04-30', 2, 500.00, 15, 7500.00, '17772162671', '王小明', '身份证', '412829199712123456', 0, '2020-04-15 09:11:03', '2020-04-15 09:12:19');
INSERT INTO `order_info` VALUES (2, 1, 1, '北京市辖区东城区安定门', '2020-04-01', '2020-04-06', 2, 179.00, 5, 895.00, '17772162671', '王小明', '身份证', '412829199712123456', 0, '2020-04-15 09:13:39', '2020-04-15 09:14:08');
INSERT INTO `order_info` VALUES (3, 1, 2, '北京市辖区东城区', '2020-04-08', '2020-04-11', 1, 180.00, 3, 540.00, '17772162671', '王小明', '身份证', '412829199712123456', 0, '2020-04-15 09:15:34', '2020-04-15 09:16:26');
INSERT INTO `order_info` VALUES (4, 1, 3, '北京市辖区东城区', '2020-04-15', '2020-04-17', 2, 150.00, 2, 300.00, '17772162671', '王小明', '身份证', '412829199712123456', 0, '2020-04-15 09:17:22', '2020-04-15 09:17:48');
INSERT INTO `order_info` VALUES (5, 1, 6, '北京市辖区昌平区', '2020-06-15', '2020-06-17', 2, 500.00, 2, 1000.00, '17772162671', '王小明', '身份证', '412829199712123456', 0, '2020-05-15 09:19:11', '2020-05-15 09:19:11');
INSERT INTO `order_info` VALUES (6, 1, 5, '北京市辖区东城区', '2020-05-15', '2020-06-30', 2, 250.00, 45, 11250.00, '17772162671', '王小明', '身份证', '412829199712123456', 0, '2020-05-15 09:26:04', '2020-05-15 09:26:04');
INSERT INTO `order_info` VALUES (7, 3, 6, '北京市辖区昌平区', '2020-04-19', '2020-04-22', 2, 500.00, 3, 1500.00, '18336232733', '王小二', '身份证', '412829199811116789', 0, '2020-04-15 09:39:03', '2020-04-15 09:39:03');
INSERT INTO `order_info` VALUES (8, 1, 2, '北京市辖区东城区', '2020-06-17', '2020-06-20', 1, 180.00, 3, 540.00, '17772162671', '柴立文', '身份证', '14444', 0, '2020-06-10 10:08:58', '2020-06-10 10:08:58');
...
CREATE TABLE `review`  (
  ...
  `user_id` int(20) NOT NULL COMMENT '用户ID',
  `home_id` int(20) NOT NULL COMMENT '房屋ID',
  `user_review` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '评论内容',
  `host_review` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '房东回复',
  `rate` decimal(2, 1) NOT NULL COMMENT '评分',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of review
-- ----------------------------
INSERT INTO `review` VALUES (1, 1, 1, 6, '海内存知己，天涯若比邻。', '海内存知己，天涯若比邻。', 5.0, '2020-05-15 09:32:37', '2020-05-15 09:42:19');
INSERT INTO `review` VALUES (3, 2, 1, 1, '长路漫漫，唯剑作伴。', NULL, 5.0, '2020-05-15 09:34:56', '2020-05-15 09:34:56');
INSERT INTO `review` VALUES (4, 7, 3, 6, '不错哦。离地铁站和学校特别近 描述和实际相符 装修也很好 有家的感觉 温馨干净宽敞美观 希望下次还来入住这里。超级赞,房间漂亮而且住的很舒服.房东超好的,很耐心.', NULL, 4.0, '2020-05-15 09:41:20', '2020-05-15 09:41:20');
...
CREATE TABLE `user`  (
  ...
  `nick` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '用户昵称',
  ...
  `type` int(1) UNSIGNED ZEROFILL NOT NULL DEFAULT 0 COMMENT '账户类型：0用户，1房东和用户',
  `status` int(1) UNSIGNED ZEROFILL NOT NULL DEFAULT 0 COMMENT '账号状态：0启用，1禁用',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, '17772162671', 'e10adc3949ba59abbe56e057f20f883e', '卡卡', '女', '111', 'http://localhost:8000/minshuku/img/5483199078c34610924d002fdb63c004.jpg', 0, 0, '2020-05-15 07:28:56', '2020-06-10 10:14:40');
INSERT INTO `user` VALUES (2, '18595331628', 'e10adc3949ba59abbe56e057f20f883e', '且随疾风前行', '男', '18595331628', 'http://localhost:8000/minshuku/img/2998d6df6080438ba21bd99dc23b6a51.jpg', 0, 0, '2020-05-15 07:31:00', '2020-06-02 09:17:59');
INSERT INTO `user` VALUES (3, '18336232733', 'e10adc3949ba59abbe56e057f20f883e', '18336232733', '男', '18336232733', 'http://localhost:8000/minshuku/img/c89feb451b96441ebe5c56c7097b430e.jpg', 0, 0, '2020-05-15 09:36:23', '2020-05-20 21:02:53');
